...
import 'settings_ shopkeeper.dart';

class Edit_Shop_Number extends StatefulWidget {
  @override
  State<Edit_Shop_Number> createState() => _Edit_Shop_NumberState();
}
...
class _Edit_Shop_NumberState extends State<Edit_Shop_Number> {
  @override
                ...
                child: defultButton(
                  ...
                  function: () {
                    if (formKey.currentState!.validate()) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Settings_Shopkeeper()),
                      );
                    }
                  },
                  width: buttonWidth,
