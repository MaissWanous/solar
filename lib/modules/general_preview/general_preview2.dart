...
import 'package:udemy_flutter/modules/general_preview/general_preview3.dart';


class General_Preview2 extends StatelessWidget {
      ...
      onHorizontalDragEnd: (details) {
        if (details.primaryVelocity != null) {
          if (details.primaryVelocity! < -200) {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => General_preview3()),
            );
          } else if (details.primaryVelocity! > 200) {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => General_Preview()),
            );
          }
        }
      },
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context)=>General_preview3(),
                          ),
                        );
                      },
                      child: Text(
