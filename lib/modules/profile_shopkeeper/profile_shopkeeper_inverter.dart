...
class Profile_Shopkeeper_Inverters extends StatefulWidget {
//final String sellerName;

//const Profile_Shopkeeper_SolarPanel({Key? key, required this.sellerName}) : super(key: key);

  @override
  State<Profile_Shopkeeper_Inverters> createState() =>
      _Profile_Shopkeeper_InverterslState();
}
...
class _Profile_Shopkeeper_InverterslState
    extends State<Profile_Shopkeeper_Inverters> {
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 10),
            _buildButton('Inverters', yellow, Colors.white, context, 2),
            SizedBox(width: 10),
...
Widget buildInverterItem(BuildContext context) => Row(
      children: [
        Expanded(
          child: Container(
            decoration: BoxDecoration(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: AssetImage(
                          'assetss/images/Peerson in working.png',
                        ),
                      ),
                      SizedBox(width: 5.0),
                      Text(
